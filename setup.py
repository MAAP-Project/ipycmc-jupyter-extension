...
data_files_spec = [
    ('share/jupyter/nbextensions/ipycmc_jupyter_extension',
        nb_path, '*.js*'),
    ('share/jupyter/lab/extensions', lab_path, '*.tgz'),
    ('etc/jupyter/nbconfig/notebook.d' , HERE, 'ipycmc_jupyter_extension.json')
]
...
setup_args = dict(
    ...
    url             = 'https://github.com/MAAP-Project/ipycmc-jupyter-extension',
    license         = 'BSD',
