...
# -*- coding: utf-8 -*-
#
# ipycmc documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'ipycmc.tex', 'ipycmc Documentation',
     'Flynn Platt', 'manual'),
]
